...
__doc__ = """
| The :py:mod:`NodeGraphPySide6.constants` namespace contains variables and enums 
 used throughout the NodeGraphPySide6 library.
"""
...
class VersionEnum(Enum):
    ...
    :py:mod:`NodeGraphPySide6.constants.VersionEnum`
    """
...
class LayoutDirectionEnum(Enum):
    ...
    :py:mod:`NodeGraphPySide6.constants.ViewerLayoutEnum`
    """
...
class NodeEnum(Enum):
    """
    Node styling layout:
    :py:mod:`NodeGraphPySide6.constants.NodeEnum`
    """
    #: default node width.
    WIDTH = 160
    #: default node height.
...
class PortEnum(Enum):
    """
    Port styling layout:
    :py:mod:`NodeGraphPySide6.constants.PortEnum`
    """
    #: default port size.
    SIZE = 22.0
...
class PortTypeEnum(Enum):
    ...
    :py:mod:`NodeGraphPySide6.constants.PortTypeEnum`
    """
...
class PipeEnum(Enum):
    """
    Pipe styling layout:
    :py:mod:`NodeGraphPySide6.constants.PipeEnum`
    """
    #: default width.
    WIDTH = 1.2
    #: default color.
...
class PipeSlicerEnum(Enum):
    ...
    :py:mod:`NodeGraphPySide6.constants.PipeSlicerEnum`
    """
    #: default width.
    WIDTH = 1.5
    #: default color.
...
class PipeLayoutEnum(Enum):
    ...
    :py:mod:`NodeGraphPySide6.constants.PipeLayoutEnum`
    """
...
class NodePropWidgetEnum(Enum):
    """
    Mapping used for the :class:`NodeGraphPySide6.PropertiesBinWidget` to display a
    node property in the specified widget type.

    :py:mod:`NodeGraphPySide6.constants.NodePropWidgetEnum`
    """
