...
class BackdropNode(NodeObject):
    """
    The ``NodeGraphPySide6.BackdropNode`` class allows other node object to be
    nested inside, it's mainly good for grouping nodes together.

    .. inheritance-diagram:: NodeGraphPySide6.BackdropNode
    ...
    def wrap_nodes(self, nodes):
        ...
        Args:
            nodes (list[NodeGraphPySide6.NodeObject]): list of nodes.
        """
        if not nodes:
            return
    ...
    def nodes(self):
        ...
        Returns:
            list[NodeGraphPySide6.BaseNode]: list of node under the backdrop.
        """
