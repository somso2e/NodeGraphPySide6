#!/usr/bin/python
from NodeGraphPySide6.errors import PortRegistrationError
from NodeGraphPySide6.nodes.base_node import BaseNode
from NodeGraphPySide6.qgraphics.node_port_in import PortInputNodeItem
from NodeGraphPySide6.qgraphics.node_port_out import PortOutputNodeItem


class PortInputNode(BaseNode):
    """
    The ``PortInputNode`` is the node that represents a input port from a
    :class:`NodeGraphPySide6.GroupNode` when expanded in a
    :class:`NodeGraphPySide6.SubGraph`.

    .. inheritance-diagram:: NodeGraphPySide6.nodes.port_node.PortInputNode
        :parts: 1
    ...
    def add_output(self, name='output', multi_output=True, display_name=True,
        ...
        """
        Warnings:
            This function is called by :meth:`NodeGraphPySide6.SubGraph.expand_group_node`
...
class PortOutputNode(BaseNode):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.nodes.port_node.PortOutputNode
        :parts: 1
