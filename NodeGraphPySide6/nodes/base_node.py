...
from NodeGraphPySide6.base.commands import NodeVisibleCmd, NodeWidgetVisibleCmd
from NodeGraphPySide6.base.node import NodeObject
from NodeGraphPySide6.base.port import Port
from NodeGraphPySide6.constants import NodePropWidgetEnum, PortTypeEnum
from NodeGraphPySide6.errors import (
    PortError,
    PortRegistrationError,
    NodeWidgetError
)
from NodeGraphPySide6.qgraphics.node_base import NodeItem
from NodeGraphPySide6.widgets.node_widgets import (
    NodeBaseWidget,
    NodeCheckBox,
    NodeComboBox,
    NodeLineEdit
...
class BaseNode(NodeObject):
    """
    The ``NodeGraphPySide6.BaseNode`` class is the base class for nodes that allows
    port connections from one node to another.

    .. inheritance-diagram:: NodeGraphPySide6.BaseNode
    ...
    def add_custom_widget(self, widget, widget_type=None, tab=None):
        ...
        Args:
            ...
            widget_type: widget flag to display in the
                ...
                (default: :attr:`NodeGraphPySide6.constants.NodePropWidgetEnum.HIDDEN`).
    ...
    def add_input(self, name='input', multi_input=False, display_name=True,
        ...
        Returns:
            NodeGraphPySide6.Port: the created port object.
        """
    ...
    def get_input(self, port):
        ...
        Returns:
            NodeGraphPySide6.Port: node port.
        """
        if type(port) is int:
    ...
    def input_ports(self):
        ...
        Returns:
            list[NodeGraphPySide6.Port]: node input ports.
        """
        return self._inputs
    ...
    def output_ports(self):
        ...
        Returns:
            list[NodeGraphPySide6.Port]: node output ports.
        """
    ...
    def input(self, index):
        ...
        Returns:
            NodeGraphPySide6.Port: port object.
        """
    ...
    def set_input(self, index, port):
        ...
        Args:
            ...
            port (NodeGraphPySide6.Port): port object.
        """
    ...
    def add_accept_port_type(self, port, port_type_data):
        ...
        See Also:
            :meth:`NodeGraphPySide6.BaseNode.accepted_port_types`

        Args:
            port (NodeGraphPySide6.Port): port to assign constrain to.
    ...
    def add_reject_port_type(self, port, port_type_data):
        ...
        See Also:
            :meth:`NodeGraphPySide6.Port.rejected_port_types`
    ...
    def on_input_connected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (NodeGraphPySide6.Port): source input port from this node.
            out_port (NodeGraphPySide6.Port): output port that connected to this node.
        """
        return
    ...
    def on_input_disconnected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (NodeGraphPySide6.Port): source input port from this node.
            out_port (NodeGraphPySide6.Port): output port that was disconnected.
        """
        return
