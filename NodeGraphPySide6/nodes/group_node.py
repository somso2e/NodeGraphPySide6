...
from NodeGraphPySide6.qgraphics.node_group import GroupNodeItem
...
class GroupNode(BaseNode):
    ...
    The ``NodeGraphPySide6.GroupNode`` class extends from the :class:`NodeGraphPySide6.BaseNode`
    class with the ability to nest other nodes inside of it.

    .. inheritance-diagram:: NodeGraphPySide6.GroupNode
