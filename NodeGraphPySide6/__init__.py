...
# -*- coding: utf-8 -*-
"""
**NodeGraphPySide6** is a node graph framework that can be implemented and re purposed
into applications that supports **PySide2**.

project: https://github.com/jchanvfx/NodeGraphPySide6
documentation: https://jchanvfx.github.io/NodeGraphPySide6/api/html/index.html
...
.. code-block:: python
    ...
    from NodeGraphPySide6 import QtWidgets, NodeGraph, BaseNode
