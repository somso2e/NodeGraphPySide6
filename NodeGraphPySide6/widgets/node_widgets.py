...
from NodeGraphPySide6.constants import ViewerEnum, Z_VAL_NODE_WIDGET
from NodeGraphPySide6.errors import NodeWidgetError
...
class NodeBaseWidget(QtWidgets.QGraphicsProxyWidget):
    ...
    added in a :class:`NodeGraphPySide6.BaseNode` object.

    .. inheritance-diagram:: NodeGraphPySide6.NodeBaseWidget
        :parts: 1

    Args:
        parent (NodeGraphPySide6.BaseNode.view): parent node view.
    ...
    def node(self):
        ...
        Returns:
            NodeGraphPySide6.BaseNode: parent node.
        """
        return self._node
...
class NodeComboBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.widgets.node_widgets.NodeComboBox
        :parts: 1

    .. note::
        `To embed a` ``QComboBox`` `in a node see func:`
        :meth:`NodeGraphPySide6.BaseNode.add_combo_menu`
    """
...
class NodeLineEdit(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.widgets.node_widgets.NodeLineEdit
        :parts: 1

    .. note::
        `To embed a` ``QLineEdit`` `in a node see func:`
        :meth:`NodeGraphPySide6.BaseNode.add_text_input`
    """
...
class NodeCheckBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.widgets.node_widgets.NodeCheckBox
        :parts: 1

    .. note::
        `To embed a` ``QCheckBox`` `in a node see func:`
        :meth:`NodeGraphPySide6.BaseNode.add_checkbox`
    """
