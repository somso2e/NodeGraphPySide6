...
class PropertyChangedCmd(QtGui.QUndoCommand):
    ...
    Args:
        node (NodeGraphPySide6.NodeObject): node.
...
class NodeAddedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (NodeGraphPySide6.NodeGraph): node graph.
        node (NodeGraphPySide6.NodeObject): node.
...
class NodeRemovedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (NodeGraphPySide6.NodeGraph): node graph.
        node (NodeGraphPySide6.BaseNode or NodeGraphPySide6.NodeObject): node.
    """
...
class NodeInputConnectedCmd(QtGui.QUndoCommand):
    ...
    Args:
        src_port (NodeGraphPySide6.Port): source port.
        trg_port (NodeGraphPySide6.Port): target port.
    """
...
class PortLockedCmd(QtGui.QUndoCommand):
    ...
    Args:
        port (NodeGraphPySide6.Port): node port.
    """
