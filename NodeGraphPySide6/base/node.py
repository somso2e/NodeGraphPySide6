#!/usr/bin/python
from NodeGraphPySide6.base.commands import PropertyChangedCmd
from NodeGraphPySide6.base.model import NodeModel
from NodeGraphPySide6.constants import NodePropWidgetEnum
...
class NodeObject(object):
    """
    The ``NodeGraphPySide6.NodeObject`` class is the main base class that all
    nodes inherit from.

    .. inheritance-diagram:: NodeGraphPySide6.NodeObject
    ...
    .. important:: re-implement this attribute to provide a unique node type.
        ...
        .. code-block:: python
            ...
            from NodeGraphPySide6 import NodeObject
    ...
    def graph(self):
        ...
        Returns:
            NodeGraphPySide6.NodeGraph: node graph instance.
        """
        return self._graph
    ...
    def view(self):
        ...
        Returns:
            NodeGraphPySide6.qgraphics.node_abstract.AbstractNodeItem: node item.
        """
        return self._view
    ...
    def set_view(self, item):
        ...
        Args:
            item (NodeGraphPySide6.qgraphics.node_abstract.AbstractNodeItem): node item.
        """
        if self._view:
            old_view = self._view
    ...
    def model(self):
        ...
        Returns:
            NodeGraphPySide6.base.model.NodeModel: node model object.
        """
        return self._model
    ...
    def set_model(self, model):
        ...
        Args:
            model (NodeGraphPySide6.base.model.NodeModel): node model object.
        """
        self._model = model
        self._model.type_ = self.type_
    ...
    def create_property(self, name, value, items=None, range=None,
        ...
        Args:
            ...
            items (list[str]): items used by widget type
                attr:`NodeGraphPySide6.constants.NodePropWidgetEnum.QCOMBO_BOX`
            range (tuple or list): ``(min, max)`` values used by
                :attr:`NodeGraphPySide6.constants.NodePropWidgetEnum.SLIDER`
