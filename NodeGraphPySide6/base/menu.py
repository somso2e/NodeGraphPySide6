...
from NodeGraphPySide6.errors import NodeMenuError
from NodeGraphPySide6.widgets.actions import BaseMenu, GraphAction, NodeAction
...
class NodeGraphMenu(object):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.NodeGraphMenu
        :parts: 1
    ...
    def get_menu(self, name):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphMenu: menu item.
        """
    ...
    def get_command(self, name):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphCommand: context menu command.
        """
    ...
    def add_menu(self, name):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphMenu: the appended menu item.
        """
    ...
    def add_command(self, name, func=None, shortcut=None):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphCommand: the appended command.
        """
...
class NodesMenu(NodeGraphMenu):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.NodesMenu
        :parts: 1
...
class NodeGraphCommand(object):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.NodeGraphCommand
        :parts: 1
