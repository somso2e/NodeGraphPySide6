#!/usr/bin/python
from NodeGraphPySide6.base.commands import (
    PortConnectedCmd,
    PortDisconnectedCmd,
    PortLockedCmd,
    PortUnlockedCmd,
...
from NodeGraphPySide6.base.model import PortModel
from NodeGraphPySide6.constants import PortTypeEnum
from NodeGraphPySide6.errors import PortError
...
class Port(object):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.Port
    ...
    Args:
        node (NodeGraphPySide6.NodeObject): parent node.
    ...
    def view(self):
        ...
        Returns:
            NodeGraphPySide6.qgraphics.port.PortItem: port item.
        """
        return self.__view
    ...
    def model(self):
        ...
        Returns:
            NodeGraphPySide6.base.model.PortModel: port model.
        """
        return self.__model
    ...
    def type_(self):
        ...
        Port Types:
            - :attr:`NodeGraphPySide6.constants.IN_PORT` for input port
            - :attr:`NodeGraphPySide6.constants.OUT_PORT` for output port
    ...
    def node(self):
        ...
        Returns:
            NodeGraphPySide6.BaseNode: parent node object.
        """
    ...
    def connected_ports(self):
        ...
        Returns:
            list[NodeGraphPySide6.Port]: list of connected ports.
        """
        ports = []
        graph = self.node().graph
    ...
    def add_accept_port_type(self, port_name, port_type, node_type):
        ...
        See Also:
            :meth:`NodeGraphPySide6.Port.add_reject_ports_type`,
    ...
    def add_reject_port_type(self, port_name, port_type, node_type):
        ...
        See Also:
            :meth:`NodeGraphPySide6.Port.add_accept_ports_type`,
            :meth:`NodeGraphPySide6.BaseNode.add_reject_port_type`
    ...
    def rejected_port_types(self):
        ...
        See Also:
            :meth:`NodeGraphPySide6.BaseNode.rejected_port_types`
