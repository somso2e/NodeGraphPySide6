...
from PySide6.QtCore import QObject, Signal, QMimeData, QPoint
from PySide6.QtWidgets import QVBoxLayout, QWidget, QUndoView, QApplication
...
from NodeGraphPySide6.base.node import NodeObject
from NodeGraphPySide6.base.port import Port
from NodeGraphPySide6.constants import (
    URI_SCHEME,
    URN_SCHEME,
    LayoutDirectionEnum,
    PipeLayoutEnum,
...
from NodeGraphPySide6.errors import NodeCreationError, NodeDeletionError
from NodeGraphPySide6.nodes.backdrop_node import BackdropNode
from NodeGraphPySide6.nodes.base_node import BaseNode
from NodeGraphPySide6.nodes.group_node import GroupNode
from NodeGraphPySide6.nodes.port_node import PortInputNode, PortOutputNode
from NodeGraphPySide6.widgets.node_graph import NodeGraphWidget, SubGraphWidget
from NodeGraphPySide6.widgets.viewer import NodeViewer
from NodeGraphPySide6.widgets.viewer_nav import NodeNavigationWidget
...
class NodeGraph(QObject):
    ...
    .. inheritance-diagram:: NodeGraphPySide6.NodeGraph
        :top-classes: PySide2.QObject

    .. image:: _images/graph.png
        :width: 60%
    """

    nodes_registered = Signal(list)
    """
    Signal triggered when a node is registered into the node graph.

    :parameters: list[:class:`NodeGraphPySide6.NodeObject`]
    :emits: registered nodes
    """

    node_created = Signal(NodeObject)
    """
    Signal triggered when a node is created in the node graph.

    :parameters: :class:`NodeGraphPySide6.NodeObject`
    :emits: created node
    """
    ...
    """
    node_selected = Signal(NodeObject)
    """
    ...
    :emits: selected node
    """
    node_selection_changed = Signal(list, list)
    """
    Signal triggered when the node selection has changed.

    :parameters: list[:class:`NodeGraphPySide6.NodeObject`],
                 list[:class:`NodeGraphPySide6.NodeObject`]
    :emits: selected node, deselected nodes.
    """
    node_double_clicked = Signal(NodeObject)
    """
    ...
    :emits: selected node
    """
    port_connected = Signal(Port, Port)
    """
    Signal triggered when a node port has been connected.

    :parameters: :class:`NodeGraphPySide6.Port`, :class:`NodeGraphPySide6.Port`
    :emits: input port, output port
    """
    port_disconnected = Signal(Port, Port)
    """
    ...
    :emits: input port, output port
    """
    property_changed = Signal(NodeObject, str, object)
    """
    Signal is triggered when a property has changed on a node.

    :parameters: :class:`NodeGraphPySide6.BaseNode`, str, object
    :emits: triggered node, property name, property value
    """
    data_dropped = Signal(QMimeData, QPoint)
    """
    Signal is triggered when data has been dropped to the graph.

    :parameters: :class:`PySide2.QMimeData`, :class:`PySide2.QPoint`
    ...
    """
    context_menu_prompt = Signal(object, object)
    """
    Signal is triggered just before a context menu is shown.

    :parameters: 
        :class:`NodeGraphPySide6.NodeGraphMenu` or :class:`NodeGraphPySide6.NodesMenu`, 
        :class:`NodeGraphPySide6.BaseNode`
    ...
    def _on_node_data_dropped(self, data, pos):
        ...
        Args:
            ...
            pos (QPoint): scene position relative to the drop.
        """
    ...
    def model(self):
        ...
        Returns:
            NodeGraphPySide6.base.model.NodeGraphModel: node graph model.
        """
        return self._model
    ...
    def viewer(self):
        ...
        Warnings:
            ...
            by ``NodeGraphPySide6`` components to get the widget use
        ...
        Returns:
            NodeGraphPySide6.widgets.viewer.NodeViewer: viewer interface.
        """
        return self._viewer
    ...
    def scene(self):
        ...
        Returns:
            NodeGraphPySide6.widgets.scene.NodeScene: node scene.
        """
    ...
    def set_grid_mode(self, mode=None):
        ...
        (default: :attr:`NodeGraphPySide6.constants.ViewerEnum.GRID_DISPLAY_LINES`).

        See: :attr:`NodeGraphPySide6.constants.ViewerEnum`
    ...
    def add_properties_bin(self, prop_bin):
        ...
        Args:
            prop_bin (NodeGraphPySide6.PropertiesBinWidget): properties widget.
        """
    ...
    def context_menu(self):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphMenu: context menu object.
        """
    ...
    def context_nodes_menu(self):
        ...
        Returns:
            NodeGraphPySide6.NodesMenu: context menu object.
        """
    ...
    def get_context_menu(self, menu):
        ...
        Returns:
            NodeGraphPySide6.NodeGraphMenu or NodeGraphPySide6.NodesMenu: context menu object.
        """
    ...
    def _deserialize_context_menu(self, menu, menu_data):
        ...
        Args:
            menu (NodeGraphPySide6.NodeGraphMenu or NodeGraphPySide6.NodesMenu):
                parent context menu.
    ...
    def pipe_style(self):
        ...
        Returns:
            int: pipe style value. :attr:`NodeGraphPySide6.constants.PipeLayoutEnum`
        """
    ...
    def set_pipe_style(self, style=PipeLayoutEnum.CURVED.value):
        ...
        See: :attr:`NodeGraphPySide6.constants.PipeLayoutEnum`
    ...
    def set_layout_direction(self, direction):
        ...
        **Layout Types:**
        ...
        - :attr:`NodeGraphPySide6.constants.LayoutDirectionEnum.HORIZONTAL`
        - :attr:`NodeGraphPySide6.constants.LayoutDirectionEnum.VERTICAL`
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]): a list of nodes.
        """
        nodes = nodes or []
    ...
    def register_node(self, node, alias=None):
        ...
        Args:
            node (NodeGraphPySide6.NodeObject): node object.
    ...
    def add_node(self, node, pos=None, selected=True, push_undo=True):
        ...
        Args:
            node (NodeGraphPySide6.BaseNode): node object.
    ...
    def delete_nodes(self, nodes, push_undo=True):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]): list of node instances.
            push_undo (bool): register the command to the undo stack. (default: True)
        """
        if not nodes:
            return
    ...
    def all_nodes(self):
        ...
        Returns:
            list[NodeGraphPySide6.BaseNode]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            NodeGraphPySide6.NodeObject: node object.
        """
    ...
    def get_nodes_by_type(self, node_type):
        ...
        (see: :attr:`NodeGraphPySide6.NodeObject.type_`)

        Args:
            node_type (str): node type identifier.

        Returns:
            list[NodeGraphPySide6.NodeObject]: list of nodes.
        """
    ...
    def _serialize(self, nodes):
        ...
        Args:
            nodes (list[NodeGraphPySide6.Nodes]): list of node instances.
    ...
    def _deserialize(self, data, relative_pos=False, pos=None):
        ...
        Returns:
            list[NodeGraphPySide6.Nodes]: list of node instances.
        """
    ...
    def copy_nodes(self, nodes=None):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]):
    ...
    def paste_nodes(self):
        ...
        Returns:
            list[NodeGraphPySide6.BaseNode]: list of pasted node instances.
        """
        clipboard = QApplication.clipboard()
    ...
    def duplicate_nodes(self, nodes):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]): list of nodes.
        Returns:
            list[NodeGraphPySide6.BaseNode]: list of duplicated node instances.
        """
        if not nodes:
            return
    ...
    def _update_node_rank(node, nodes_rank, down_stream=True):
        ...
        Args:
            node (NodeGraphPySide6.BaseNode): node to start from.
    ...
    def _compute_node_rank(nodes, down_stream=True):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]): nodes to start ranking from.
            down_stream (bool): true to compute down stream.

        Returns:
            dict: {NodeGraphPySide6.BaseNode: node_rank, ...}
        """
        nodes_rank = {}
        for node in nodes:
            nodes_rank[node] = 0
    ...
    def auto_layout_nodes(self, nodes=None, down_stream=True, start_nodes=None):
        ...
        Args:
            nodes (list[NodeGraphPySide6.BaseNode]): list of nodes to auto layout
                if nodes is None then all nodes is layed out.
            down_stream (bool): false to layout up stream.
            start_nodes (list[NodeGraphPySide6.BaseNode]):
    ...
    def expand_group_node(self, node):
        ...
        Args:
            node (NodeGraphPySide6.GroupNode): group node.
...
class SubGraph(NodeGraph):
    ...
    :class:`NodeGraphPySide6.GroupNode`.

    .. inheritance-diagram:: NodeGraphPySide6.SubGraph
        :top-classes: PySide2.QObject
    ...
    def _clone_context_menu_from_parent(self):
        ...
        def clone_menu(menu, menu_to_clone):
            """
            Args:
                menu (NodeGraphPySide6.NodeGraphMenu):
                menu_to_clone (NodeGraphPySide6.NodeGraphMenu):
            """
            sub_items = []
    ...
    def initialized_graphs(self):
        ...
        Returns:
            list[NodeGraphPySide6.SubGraph]: list of sub graph objects.
        """
        if self._parent_graph.is_root:
    ...
    def subviewer_widget(self):
        ...
        if self._subviewer_widget is None:
            self._subviewer_widget = QWidget()
            layout = QVBoxLayout(self._subviewer_widget)
    ...
    def parent_graph(self):
        ...
        Returns:
            NodeGraphPySide6.NodeGraph or NodeGraphPySide6.SubGraph: parent graph.
        """
    ...
    def node(self):
        ...
        Returns:
            NodeGraphPySide6.GroupNode: group node.
        """
        return self._node
    ...
    def get_input_port_nodes(self):
        ...
        Returns:
            list[NodeGraphPySide6.PortInputNode]: input nodes.
        """
    ...
    def get_output_port_nodes(self):
        ...
        Returns:
            list[NodeGraphPySide6.PortOutputNode]: output nodes.
        """
    ...
    def get_node_by_port(self, port):
        ...
        Args:
            port (NodeGraphPySide6.Port): parent node port object.
