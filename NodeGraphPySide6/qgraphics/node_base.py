...
from NodeGraphPySide6.qgraphics.node_overlay_disabled import XDisabledItem
from NodeGraphPySide6.qgraphics.node_text_item import NodeTextItem
from NodeGraphPySide6.qgraphics.port import PortItem, CustomPortItem
...
class NodeItem(AbstractNodeItem):
    ...
    def post_init(self, viewer, pos=None):
        ...
        Args:
            viewer (NodeGraphPySide6.widgets.viewer.NodeViewer): main viewer
    ...
    def post_init(self, viewer=None, pos=None):
        ...
        Args:
            viewer (NodeGraphPySide6.widgets.viewer.NodeViewer): not used
