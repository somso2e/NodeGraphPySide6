...
class _PortConnectionsContainer(QtWidgets.QWidget):
    ...
    def _on_focus_to_node(self, port):
        ...
        Args:
            port (NodeGraphPySide6.Port): connected port.
        """
        if port:
            node = port.node()
...
class NodePropWidget(QtWidgets.QWidget):
    ...
    Args:
        ...
        node (NodeGraphPySide6.BaseNode): node.
    """
    ...
    def _read_node(self, node):
        ...
        Args:
            node (NodeGraphPySide6.BaseNode): node class.
    ...
    def get_widget(self, name):
        ...
        Returns:
            NodeGraphPySide6.custom_widgets.properties_bin.prop_widgets_abstract.BaseProperty: property widget.
        """
        if name == 'name':
...
class PropertiesBinWidget(QtWidgets.QWidget):
    """
    The :class:`NodeGraphPySide6.PropertiesBinWidget` is a list widget for displaying
    and editing a nodes properties.

    .. inheritance-diagram:: NodeGraphPySide6.PropertiesBinWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from NodeGraphPySide6 import NodeGraph, PropertiesBinWidget
    ...
    See Also:
            :meth:`NodeGraphPySide6.BaseNode.add_custom_widget`,
            :meth:`NodeGraphPySide6.NodeObject.create_property`,
            :attr:`NodeGraphPySide6.constants.NodePropWidgetEnum`

    Args:
        parent (QtWidgets.QWidget): parent of the new widget.
        node_graph (NodeGraphPySide6.NodeGraph): node graph.
    """
    ...
    def __on_graph_property_changed(self, node, prop_name, prop_value):
        ...
        Args:
            node (NodeGraphPySide6.NodeObject):
    ...
    def remove_node(self, node):
        ...
        Args:
            node (str or NodeGraphPySide6.BaseNode): node id or node object.
        """
    ...
    def prop_widget(self, node):
        ...
        Args:
            node (str or NodeGraphPySide6.NodeObject): node id or node object.
