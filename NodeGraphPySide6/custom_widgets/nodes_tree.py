...
class NodesTreeWidget(QtWidgets.QTreeWidget):
    """
    The :class:`NodeGraphPySide6.NodesTreeWidget` is a widget for displaying all
    registered nodes from the node graph with this widget a user can create
    nodes by dragging and dropping.

    .. inheritance-diagram:: NodeGraphPySide6.NodesTreeWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from NodeGraphPySide6 import NodeGraph, NodesTreeWidget
