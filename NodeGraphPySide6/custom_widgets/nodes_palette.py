...
from NodeGraphPySide6.constants import URN_SCHEME
...
class NodesPaletteWidget(QtWidgets.QWidget):
    """
    The :class:`NodeGraphPySide6.NodesPaletteWidget` is a widget for displaying all
    registered nodes from the node graph in a grid layout with this widget a
    user can create nodes by dragging and dropping.

    | *Implemented on NodeGraphPySide6:* ``v0.1.7``

    .. inheritance-diagram:: NodeGraphPySide6.NodesPaletteWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from NodeGraphPySide6 import NodeGraph, NodesPaletteWidget
